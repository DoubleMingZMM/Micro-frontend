...
exports.default = exports.TOKEN_TIMEOUT_STATUS = exports.codeMessage = void 0;
...
_umiRequest.default.interceptors.request.use(function (url, options) {
...
var extendRequest = (0, _umiRequest.extend)({
...
var TOKEN_TIMEOUT_STATUS = 1002;
exports.TOKEN_TIMEOUT_STATUS = TOKEN_TIMEOUT_STATUS;

_umiRequest.default.interceptors.response.use(
/*#__PURE__*/
function () {
